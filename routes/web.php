...
Route::prefix('/admin')->middleware(['auth', 'admin'])->group(function() {
    ...
    Route::prefix('/user')->group(function() {
        ...
        Route::get('/add_user', [UserController::class, 'create'])->name('admin/user.add');
        Route::post('/add_user', [UserController::class, 'store'])->name('admin/user.add');
        Route::get('/edit_user/{user_id}', [UserController::class, 'edit'])->name('admin/user.edit');
        Route::put('/edit_user/{user_id}', [UserController::class, 'update'])->name('admin/user.edit');
        Route::put('/change_role/{user_id}', [UserController::class, 'change_role'])->name('admin/change.role');
        Route::get('/delete_user/{user_id}', [UserController::class, 'delete'])->name('admin/user.delete');
    });
    //MOVIE
    Route::prefix('/movie')->group(function() {
        Route::get('/', [MovieController::class, 'index'])->name('admin/movie');
        Route::get('/add_movie', [MovieController::class, 'create'])->name('admin/add_movie');
        Route::post('/add_movie', [MovieController::class, 'store_request'])->name('admin/add_movie');
        Route::get('/edit_movie/{movie_id}', [MovieController::class, 'edit'])->name('admin/edit_movie');
        Route::put('/edit_movie/{movie_id}', [MovieController::class, 'update'])->name('admin/edit_movie');
    ...
    Route::prefix('/hall')->group(function() {
        ...
        Route::post('/add_hall', [HallController::class, 'store'])->name('admin/add_hall');
        Route::get('/edit_hall/{hall_id}', [HallController::class, 'edit'])->name('admin/edit_hall');
        Route::put('/edit_hall/{hall_id}', [HallController::class, 'update'])->name('admin/edit_hall');
    ...
    Route::prefix('/seance')->group(function() {
        ...
        Route::post('/add_seance', [SeanceController::class, 'store'])->name('admin/add_seance');
        Route::get('/edit_seance/{seance_id}', [SeanceController::class, 'edit'])->name('admin/edit_seance');
        Route::put('/edit_seance/{seance_id}', [SeanceController::class, 'update'])->name('admin/edit_seance');
    ...
    Route::prefix('/reservation')->group(function() {
        ...
        Route::post('/add_reservation', [ReservationController::class, 'create_admin_reservation'])->name('admin/add_reservation');
        ...
        Route::put('/edit_reservation/{reservation_id}', [ReservationController::class, 'update_reservation_admin'])->name('admin/edit_reservation');
    ...
    Route::prefix('/price')->group(function() {
        ...
        Route::get('/add_price', [PriceController::class, 'add_price_form'])->name('admin/add_price');
        ...
        Route::put('/edit_price/{price_id}', [PriceController::class, 'update'])->name('admin/edit_price');
    ...
    Route::prefix('/discount')->group(function() {
        ...
        Route::get('/add_discount', [DiscountController::class, 'add_discount_form'])->name('admin/add_discount');
        ...
        Route::put('/edit_discount/{discount_id}', [DiscountController::class, 'update'])->name('admin/edit_discount');
